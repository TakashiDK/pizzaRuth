...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Nov-2023 às 01:21
...
INSERT INTO `tb_bebida` (`id_bebida`, `nm_bebida`, `vl_bebida`, `img_bebida`) VALUES
(101, 'Cerveja Budweiser', '6.00', '/src/assets/images/budweiser.png'),
(102, 'Cerveja Corona', '10.00', '/src/assets/images/corona.png'),
(103, 'Cerveja Heineken', '6.00', '/src/assets/images/heineken.png'),
(104, 'Cerveja Skol', '5.00', '/src/assets/images/skol.png'),
(105, 'Coca-Cola', '5.00', '/src/assets/images/coca.png'),
(106, 'Fanta Laranja', '5.00', '/src/assets/images/fanta.png'),
(107, 'Guaraná Antártica', '5.00', '/src/assets/images/guarana.png'),
(108, 'Schweppes', '5.00', '/src/assets/images/schweppes.png'),
(109, 'H2O Limoneto', '7.00', '/src/assets/images/h2o.png'),
(110, 'Del Valle Sabores', '6.00', '/src/assets/images/delvalle.png'),
(111, 'Chá Feelgood', '6.00', '/src/assets/images/feelgood.png'),
(112, 'Vinho Casillero Del Diablo', '50.00', '/src/assets/images/casillero.png');
...
INSERT INTO `tb_pizza` (`id_pizza`, `nm_pizza`, `vl_pizza`, `img_pizza`) VALUES
...
--
ALTER TABLE `tb_bebida`
  MODIFY `id_bebida` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT de tabela `tb_pizza`
--
ALTER TABLE `tb_pizza`
  MODIFY `id_pizza` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
